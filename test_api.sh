...
cd /home/ubuntu/custorix-crm-implementation/backend
source venv/bin/activate

echo "Setting up test environment for API testing..."
# Install testing dependencies
pip install pytest pytest-django requests

# Create test configuration
cat > /home/ubuntu/custorix-crm-implementation/backend/api_tests.py << 'EOF'
import requests
import json
import unittest
...
echo "Running API tests (simulated)..."
python /home/ubuntu/custorix-crm-implementation/backend/api_tests.py
